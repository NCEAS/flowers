...
show in the OHI example above.  One can provide a color palette (`colors`) to control
the gradient used.

Alternatively, you can also color the petals with fixed colors determined by the
`name_flower` categories, in which case you will likely want to provide a `colors`
palette with at least as many colors as you have petals in the plot. Here's an
example with four fixed petals:
